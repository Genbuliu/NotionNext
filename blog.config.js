...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，Welcome to the GENBU working group! How can I assist you today?',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'GENBU', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Working Group', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.genbu.store', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'GENBU, BOLG', // 网站关键词 英文逗号隔开
...
//      process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_AUTO || '8807314373', // Google AdScene>广告>按单元广告>新建展示广告 （自动广告）
 ...
 //   AD_WWADS_BLOCK_DETECT: process.env.NEXT_PUBLIC_WWADS_AD_BLOCK_DETECT || false, // 是否开启WWADS广告屏蔽插件检测,开启后会在广告位上以文字提示 @see https://github.com/bytegravity/whitelist-wwads
  ...
  // RSS订阅
  ENABLE_RSS: process.env.NEXT_PUBLIC_ENABLE_RSS || false, // 是否开启RSS订阅功能   true  false
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'GENBU', // 站点描述，被notion中的页面描述覆盖
